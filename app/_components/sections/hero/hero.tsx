...
export async function Hero() {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-center text-5xl font-bold text-black dark:text-white sm:text-7xl md:text-9xl">
        {data.title}
      </h1>
      <p className="text-color !mb-4 text-center text-xl sm:text-2xl md:text-3xl">
        {data.description}
      </p>
